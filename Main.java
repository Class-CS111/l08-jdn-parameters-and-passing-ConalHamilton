  ...
  public static void main(String[] args) 
{
	...
	dayToday = 26;
	yearToday = 1918;
	System.out.println(calcJulianDate(monthToday, dayToday, yearToday));
	//System.out.println(calcJulianDate(3,2,2025)); //Test for today's date, should return 2460737
	//System.out.println(calcJulianDate(8,26,1918)); //Test for Katherine Johnson's birthday, should return 2421832
